...
SCRIPT_NAME_DEFAULT = "stereo_sync_stack_v11.py"
VIDEO_FILETYPES = [
...
class StereoSyncGUI(ttk.Frame):
    ...
    def _build_output_tab(self, notebook):
        ...
        self._add_field(vid, 3, "--fps", "fps")
        self.stereo_combo = self._add_combo(vid, 4, "--stereo-output", "stereo_output", ["sbs", "ou", "anaglyph"])
        self.anaglyph_combo = self._add_combo(vid, 5, "--anaglyph-mode", "anaglyph_mode", ["arcd", "arcc", "arch", "arcg"])
